...
Common
    ...
    cargo install mdcat   # or use your package manager
...
Installation
    ...
    If you keep the source $pyenv line, create the environment:
    bash
    ...
    Pull the local model (for ai.sh)
    bash
...
ps	Show the status of the model (running or not)
